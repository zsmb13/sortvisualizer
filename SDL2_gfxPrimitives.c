...
This is a modified version of the orginal file, the xxxColour functions
have been modified for use with little-endian systems.

Contact: zsmb13 at sch dot bme dot hu
